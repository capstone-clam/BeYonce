...
export class AllDresses extends Component {
    componentDidMount() {
    ...
    render() {
        ...
        return(
            <div className='allDreses'>
                        <h2>Dresses: </h2>
                        {
                            category.map(item =>
                                <div id="dresspics" key={item.id}>
...
export default connect(mapStateToProps, mapDispatchToProps)(AllDresses)